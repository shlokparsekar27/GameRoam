...
import { Search, MapPin, Filter, ShoppingBag, Gamepad2, Loader2, MessageCircle, X, ExternalLink, Calendar } from 'lucide-react';
...
export default function Marketplace({ session }) {
  ...
  const [platformFilter, setPlatformFilter] = useState('All'); // PS5, PC, etc.
  ...
  async function fetchMarketplace() {
    try {
      ...
      const { data, error } = await supabase
        ...
        .select(`
          *,
          owner:profiles ( username, location, avatar_url, email )
        `)
        .neq('owner_id', session.user.id) // Don't show my own games
    ...
    <div className="space-y-8 animate-in fade-in duration-500 pb-12">
              ...
              <div className="p-4 flex flex-col flex-1">
                ...
                <div className="mt-auto pt-4 border-t border-slate-800 flex items-center gap-3">
                  ...
                  <div className="min-w-0">
                    <p className="text-slate-300 text-xs font-bold truncate">{game.owner?.username || "Unknown"}</p>
      ...
      {selectedGame && (
        <div className="fixed inset-0 bg-black/80 backdrop-blur-md z-50 flex items-center justify-center p-4 animate-in fade-in duration-200">
          <div className="bg-slate-900 w-full max-w-2xl rounded-3xl border border-slate-800 shadow-2xl overflow-hidden relative flex flex-col md:flex-row">
            ...
            <div className="w-full md:w-1/2 p-8 flex flex-col">
              ...
              {/* Description Placeholder (You can add a description field to DB later) */}
              <div className="mb-8">
                ...
                <p className="text-slate-300 text-sm leading-relaxed">
                  ...
                  Connect with them to arrange the details.
                </p>
              </div>
              ...
              <div className="mt-auto bg-slate-950/50 rounded-xl p-4 border border-slate-800">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    <p className="font-bold text-white">{selectedGame.owner?.username}</p>
                ...
                >
                  <MessageCircle size={18} /> Chat with Saleer
                </button>
              </div>
