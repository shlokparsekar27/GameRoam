      ...
      <div className="bg-void-800 border border-white/5 clip-chamfer p-1 mb-10 relative">
        ...
        <div className="relative z-10 bg-void-900 clip-chamfer p-6 md:p-10 flex flex-col md:flex-row gap-8 items-start">
          ...
          <div className="relative shrink-0 mx-auto md:mx-0">
             <div className="w-32 h-32 clip-chamfer bg-void-800 border border-white/10 p-1">
                <div className="w-full h-full bg-void-950 clip-chamfer overflow-hidden flex items-center justify-center">
                    {profile.avatar_url ? (
                      <img src={profile.avatar_url} className="w-full h-full object-cover opacity-80" />
                    ) : (
                      <span className="text-4xl font-mech font-bold text-void-700">{profile.username?.[0]?.toUpperCase()}</span>
                    )}
                </div>
             </div>
          </div>
